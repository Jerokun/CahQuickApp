namespace CahBackend.GameLogic
{
  ...
  'science': {
    'name': 'Science Pack',
    'black': [314, 315, 316, 317, 318, 319, 320],
    'white': [
      1249,
      1250,
      1251,
  ...
  'www': {
    ...
    'black': [321, 322, 323, 324, 325, 326, 327, 328, 329],
    'white': [
      1272,
      1273,
      1274,
  ...
  'hillary': {
    ...
    'black': [330, 242, 331],
    'white': [1293, 1294, 1295, 1296, 1297, 1298, 1299, 1300, 1301, 1302, 1303],
    'icon': 'venus'
  },
  'trumpvote': {
  ...
  'xmas2012': {
    ...
    'black': [338, 339, 340, 341, 342, 343, 344],
    'white': [
      1338,
      1339,
      1340,
  ...
  'xmas2013': {
    ...
    'black': [345, 346, 347, 348, 349, 350, 351, 352, 353],
    'white': [
      1361,
      1362,
      1363,
  ...
  'PAXP2013': {
    'name': 'PAX Prime 2013',
    'black': [360, 361, 362, 363, 364, 365, 366],
    'white': [
      1406,
      1407,
      1408,
  ...
  'PAXEP2014': {
    ...
    'black': [372, 373],
    'white': [1465, 1466, 1467, 1468, 1469, 1470, 1215, 1471],
    'icon': 'users'
  },
  'PAXPP2014': {
    'name': 'PAX Prime 2014 Panel Pack',
    'black': [374, 375, 376, 377, 378],
    'white': [1472, 1473, 1474, 1475, 1476, 1477],
    'icon': 'user-times'
  },
  'PAX2015': {
    'name': 'PAX Prime 2015 Food Packs',
    'black': [308, 379, 310, 380, 312, 381],
    'white': [
      1225,
      1226,
      1227,
  ...
  'HOCAH': {
    ...
    'black': [382, 383, 384, 385, 386, 387, 388, 389, 390],
    'white': [
      1478,
      1479,
      1480,
  ...
  'reject': {
    'name': 'Reject Pack',
    'black': [391, 392, 393, 394, 395, 396, 397, 398],
    'white': [
      1493,
      1494,
      1495,
  ...
  'reject2': {
    'name': 'Reject Pack 2',
    'black': [399, 400, 401, 402, 403, 404, 405, 406, 407, 408],
    'white': [
      1509,
      1510,
      1511,
  ...
  'misprint': {
    ...
    'black': [89],
    'white': [451, 452, 453, 454, 455, 456, 457, 458, 459],
    'icon': 'print'
  },
  'order': [
    'Base',
    ...
    'misprint'
        ...
        public CardCollection cardCollection = JsonConvert.DeserializeObject<CardCollection>(json);

        public Deck BuildDeck()
        {
            Deck Deck = null;
            Deck.WhiteCards = BuildWhiteCards(60);
            Deck.BlackCards = BuildBlackCards(20);

            return Deck;
        }

        public List<CahBackend.Models.Deck.BlackCard> BuildBlackCards(int amount)
        {
            int arrayLength = cardCollection.WhiteCards.Length;
            List<CahBackend.Models.Deck.BlackCard> blackCards = null;
            List<int> randomHistory = null;
            int randomNumber;
            while (blackCards.Count <= amount)
            {
                var rand = new Random();
                randomNumber = rand.Next(arrayLength);
                if (!randomHistory.Contains(randomNumber))
                {
                    randomHistory.Add(randomNumber);
                    blackCards.Add(new CahBackend.Models.Deck.BlackCard 
                    { 
                        Pick = cardCollection.BlackCards[randomNumber].Pick,
                        Text = cardCollection.BlackCards[randomNumber].Text,
                    });
                }
            }
            return blackCards;
        ...
        public List<CahBackend.Models.Deck.WhiteCard> BuildWhiteCards(int amount)
        {
            int arrayLength = cardCollection.WhiteCards.Length;
            List<CahBackend.Models.Deck.WhiteCard> whiteCards = null;
            List<int> randomHistory = null;
            int randomNumber;
            while (whiteCards.Count <= amount)
            {
                var rand = new Random();
                randomNumber = rand.Next(arrayLength);
                if (!randomHistory.Contains(randomNumber))
                {
                    randomHistory.Add(randomNumber);
                    whiteCards.Add(new WhiteCard { Text = (cardCollection.WhiteCards[randomNumber]) });
                }
            }
            return whiteCards;
        }
        ...
        {
            return cardCollection.WhiteCards;
        }
    }
}
